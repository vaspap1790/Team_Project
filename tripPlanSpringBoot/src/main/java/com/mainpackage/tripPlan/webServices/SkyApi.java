...
public class SkyApi {
   ...
   ///////////////////////////////////////////////////////////
   public String redirectToSky(Esky e,String returnDate){
       
       
     String link= "https://www.esky.gr/flights/select/"+e.getType()+"/ap/"+e.getOriginPlace()+"/ap/"+e.getDestinationPlace()+""
             + "?departureDate="+e.getDepartureDate()+"&returnDate="+returnDate+""
             + "&pa="+e.getPa()+"&py="+e.getPy()+"&pc="+e.getPc()+"&pi="+e.getPi()+"&sc="+e.getSc();
